...
class DataCleaning(luigi.Task):
	...
	def input(self):
		return luigi.LocalTarget(os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data\\IL_13062017_WBAN_13802.csv")
	...
	def run(self):
		...
		csv_data_df =pd.read_csv(self.input(),encoding='ISO-8859-1',
	...
	def output(self):
		return luigi.LocalTarget(os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\clean_data\\IntialData\\IL_13062017_WBAN_13802_clean.csv")
