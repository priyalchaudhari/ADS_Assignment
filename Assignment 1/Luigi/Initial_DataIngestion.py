...
class DownloadInitialDataSet(luigi.Task):
	...
	def run(self):
		...
		data_path = os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data"
		...
		if aws_bucket in bucket_list:

			if not os.path.exists(os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data\\IntialData\\*.csv"):
				...
				os.rename(os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data\\IntialData\\Temp.csv", os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data\\IntialData\\" + actual_file_initial)
	...
	def output(self):
		return luigi.LocalTarget(os.path.expanduser("~") + "\\Team6_ADS_Assignment1\\Luigi\\Data\\IntialData\\Temp.csv")
